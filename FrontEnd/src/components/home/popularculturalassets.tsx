    ...
    return (
        ...
        renderItem={({item})=>(
          ...
          style={[styles.region, isLocation===item ? styles.sel_region : null]}>
              <Text style={isLocation===item ? styles.sel_region_text : styles.region_text}>
                  {item}
              </Text>
          </TouchableOpacity>
        )}/>
        ...
        <View style={{flexDirection:'row',width:'100%', marginTop:10, justifyContent:'space-between'}}>
          ...
          <View style={{marginLeft:20, justifyContent:'center', width:'60%'}}>
            ...
            <Text style={{color:'#A6A6A6', marginBottom:5}}>경상북도 경주시 인왕동 839-1</Text>
            <View style={{flexDirection:'row', alignItems:'center'}}>
              <Icon name="heart" size={15} color='#E74B2C' style={{marginRight:10}}/>
