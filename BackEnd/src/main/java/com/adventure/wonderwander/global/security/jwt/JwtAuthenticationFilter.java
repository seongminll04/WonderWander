...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
        ...
        if (httpServletRequest.getRequestURI().equals("/api/v1/refresh")) {
    ...
    public void checkRefreshTokenAndReIssueAccessToken(HttpServletResponse httpServletResponse, String refreshToken) {
        ...
        if(redisEmail != null) {
            Optional<User> user = userRepository.findByUserid(redisEmail);
            ...
            if(user.isPresent()) {
                ...
                jwtService.sendAccessAndRefreshToken(
                        httpServletResponse,
                        jwtService.createAccessToken(user.get().getUserid()),
    ...
    public String reIssueRefreshToken(User user) {
        ...
        redisRefreshTokenService.setRedisRefreshToken(reIssuedRefreshToken, user.getUserid());
                ...
                .ifPresent(accessToken -> {
                    if (jwtService.isTokenValid(accessToken)) {
                        ...
                        jwtService.extractEmail(accessToken)
                                .ifPresent(id -> userRepository.findByUserid(id)
